...
<html>
	...
	<div id="build">
	<form name="buildOwn" style=" border:4px double black; border-radius: 10px;margin-left:400px;margin-right:500px;width:550px;height:900px;padding:50px 50px 50px 150px;" onsubmit="return(validate());" >
				...
				<div  style="margin: 1px 35px; ">
					<a href="create_own.html" style="text-decoration: none"> <input type="button" value="Clear" height="25" width="30" id="create_own_clear" style="background-color: #ccd1d1;font-size: 105%; margin: 5px auto; border-radius: 4px; cursor:pointer; "></a>
					<input type="submit" value="Submit" height="25" width="30" id="create_own_submit" style="background-color: #4CAF50;font-size: 125%; margin: 5px auto; border-radius: 4px; cursor:pointer;" >
					<a href="Home.html" style="text-decoration: none"> <input type="button" value="Cancel" height="25" width="30" id="create_own_cancel" style="background-color: #ccd1d1;font-size: 105%; margin: 5px auto; border-radius: 4px; cursor:pointer;" >
					</a>
